                            ...
                            <table class="table border mb-0">
                                ...
                                <tbody>
                                    <tr class="align-middle">
                                        <td class="text-center">
                                            <div class="avatar avatar-md"><img class="avatar-img"
                                                    src="images/female_avatar2.svg" alt="user@email.com"><span
                                    ...
                                    <tr class="align-middle">
                                        <td class="text-center">
                                            <div class="avatar avatar-md"><img class="avatar-img"
                                                    src="images/male_avatar1.svg" alt="user@email.com"><span
                                    ...
                                    <tr class="align-middle">
                                        <td class="text-center">
                                            <div class="avatar avatar-md"><img class="avatar-img"
                                                    src="images/male_avatar2.svg" alt="user@email.com"><span
